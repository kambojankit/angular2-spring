...
import com.techarha.java.ecomm.model.Product;
 ...
 *         &lt;element ref="{http://www.techarha.com/schema/xsd/ecomm/Product}Product"/>
...
@XmlRootElement(name = "updateProductDetailsRequest")
public class UpdateProductDetailsRequest {
    ...
    protected UID uid;
    @XmlElement(name = "Product", namespace = "http://www.techarha.com/schema/xsd/ecomm/Product", required = true)
