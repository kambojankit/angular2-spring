...
import com.techarha.java.ecomm.request.AddVariantDetailsRequest;
import com.techarha.java.ecomm.request.GetProductDetailsRequest;
import com.techarha.java.ecomm.request.UpdateProductDetailsRequest;
import com.techarha.java.ecomm.request.UpdateVariantDetailsRequest;
import com.techarha.java.ecomm.response.AddProductDetailsResponse;
import com.techarha.java.ecomm.response.AddVariantDetailsResponse;
import com.techarha.java.ecomm.response.GetProductDetailsResponse;
import com.techarha.java.ecomm.response.PingResponse;
import com.techarha.java.ecomm.response.UpdateProductDetailsResponse;
import com.techarha.java.ecomm.response.UpdateVariantDetailsResponse;
